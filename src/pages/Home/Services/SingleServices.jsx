...
const SingleServices = ({ items }) => {
  ...
  return (
    <Tilt options={defaultOptions}>
      <div className="card w-full h-fit bg-base-100 shadow-2xl">
        <figure><img className="w-16 my-5  h-16  rounded-full" src={img} alt="Shoes" /></figure>
        <div className="card-body">
          <h2 className="card-title mx-auto">{title}</h2>
          <p className=" text-[#F63E7B] text-xl font-semibold mx-auto">$ {price}</p>
          <p className="text-base text-gray-500 text-center h-10">{des}</p>
